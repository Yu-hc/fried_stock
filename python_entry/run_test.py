...
processed_df = factory.process(raw_df)

# Create environment with Module B
env = StockTradingEnv(df=processed_df, initial_balance=10000.0, window_size=30)

# Initialize agent with Module D
agent = TradingAgent(env=env, model_path="../models/")
